...
_C.DATASET = CN()
_C.DATASET.ROOT = 'C:\\Users\\yujin\\HRNet\\HRNet-Semantic-Segmentation-HRNet-OCR\\data\\pole\\annotations'
_C.DATASET.DATASET = 'pole'  # 데이터셋 이름을 적절하게 설정하세요
_C.DATASET.NUM_CLASSES = 21
_C.DATASET.TRAIN_SET = 'C:\\Users\\yujin\\HRNet\\HRNet-Semantic-Segmentation-HRNet-OCR\\data\\pole\\annotations\\instances_default.json'
_C.DATASET.EXTRA_TRAIN_SET = ''
_C.DATASET.TEST_SET = 'C:\\Users\\yujin\\HRNet\\HRNet-Semantic-Segmentation-HRNet-OCR\\data\\pole\\annotations\\instances_default.json'
