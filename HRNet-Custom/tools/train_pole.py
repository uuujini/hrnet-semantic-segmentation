...
from datasets.custom_dataset import CustomDataset  # 추가
...
def main():
    ...
    for epoch in range(last_epoch, end_epoch):
        train(config, epoch, config.TRAIN.END_EPOCH, epoch_iters, config.TRAIN.LR, num_iters, trainloader, optimizer, model, writer_dict)
